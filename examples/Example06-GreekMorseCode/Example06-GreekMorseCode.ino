...
//This will be used to hold the Morse translation of the Greek characters.
char morseArray[100];
...
void loop()
{
    ...
    //Convert the Greek message.
    //The 100 at the end tells convertMorseFromGreek that morseArray can only
    //hold 100 characters.
    int errorCode = convertMorseFromGreek(greekMessage, morseArray, 100);
