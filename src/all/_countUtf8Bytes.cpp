...
unsigned char _countUtf8Bytes(const char *bytes)
{
    ...
    {
        //bytes[1] is not a continuation byte.
        return 0;
    }
    ...
    else if ((bytes[2] & 0b11000000) != 0b10000000)
    {
        //bytes[2] is not a continuation byte.
        return 0;
    }
    ...
    else if ((bytes[3] & 0b11000000) != 0b10000000)
    {
        //bytes[3] is not a continuation byte.
        return 0;
    }
