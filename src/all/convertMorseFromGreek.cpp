...
static int convertMorseFromGreek(const unsigned char greekMessage[], unsigned char englishBuffer[], size_t englishBufferSize)
{
    ...
    const unsigned char *source = greekMessage;
...
{
    return convertMorseFromGreek(reinterpret_cast<const unsigned char *>(greekMessage), reinterpret_cast<unsigned char *>(englishBuffer), englishBufferSize);
}
