...
{
    sendMorse(message, (void (*)(void *))delayFunction, (void (*)(void *))dotFunction, (void (*)(void *))dashFunction, nullptr);
}
...
{
    return sendMorse(message, (int (*)(void *))delayFunction, (int (*)(void *))dotFunction, (int (*)(void *))dashFunction, nullptr);
}
